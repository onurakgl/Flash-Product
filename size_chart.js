 ...
 * Build Date: 03.05.2026 20:27:29
 * (c) 2026 Yuddy
 */
var SizeChart = (function (exports) {
    ...
    function getApplicableTablesForProduct(sizeTables, productId) {
        ...
        return sizeTables.filter((table) => {
            ...
            return table.applicableProducts.some((product) => product.id === productId || product.slug === productId);
        });
    }
    ...
    function getApplicableSuggestionsForProduct(sizeSuggestions, productId) {
        ...
        return sizeSuggestions.filter((suggestion) => {
            ...
            return suggestion.applicableProducts.some((product) => product.slug === productId);
        });
    }
